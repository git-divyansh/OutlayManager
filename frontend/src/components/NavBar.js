  ...
  return (
    <div>
         ...
         <div className=' flex flex-row  justify-between w-screen h-24 bg-neutral-950' >
          <div className='left text-red-500 font-bold tracking-wider text-6xl top-5 left-10 relative '>
            <p className='text-white'><span className='text-yellow-500' >Outlay</span> Manager</p>  
          </div>
